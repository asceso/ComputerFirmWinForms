...
namespace CoreClient.StyleExtensions.Components
{
    public partial class RoundButtonComponent : Component
    {
        ...
        public RoundButtonComponent() => InitializeComponent();

        public RoundButtonComponent(IContainer container)
        {
            container.Add(this);
        ...
        public void DefineRounding(Control.ControlCollection controls)
        {
            ...
            {
                if (ctrl is BaseStyledButton btn)
                {
